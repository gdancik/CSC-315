...
par(mfrow = c(2,2))
curve(dunif(x), from = 0, to = 1, col = "blue", lty = 2, lwd = 2, 
      main = "Uniform Distribution", ylab = "density", xlab = "x")
curve(dexp(x), from = 0, to = 10, col = "blue", lty = 2, lwd = 2,
      main = "Exponential Distributon", ylab = "density", xlab = "x")
curve(dchisq(x, df = 3), from = 0, to = 10, col = "blue", lty = 2, lwd = 2,
      main = "Chi-squared Distribution", ylab = "density", xlab = "x")
curve(dnorm(x, mean = 5, sd = 1), from = 0, to = 10, col = "blue", lty = 2, lwd = 2,
      main = "Normal Distribution", ylab = "density", xlab = "x")
par(par.orig)
...
par(mfrow = c(1,2))
x = seq(60, 75, by = .1)
d = dnorm(x, mean = 66, sd = 2)
plot(x, d, main = "Normal Distribution\n(mu = 66, sigma = 2)", 
     ylab = "density", type = "l")

x = seq(-3, 3, by = 0.1)
d = dnorm(x)    # same as dnorm(x, mean = 0, sd = 1)
plot(x, d, main = "Standard Normal Distribution\n(mu = 0, sigma = 1)", 
     ylab = "density", type = "l")
...
shade.norm(-Inf,70, mean = 68, sd = 1.7)
