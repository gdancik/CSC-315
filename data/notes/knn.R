...
###############################################################
# Let's load in the GSE1297 data again. We will do this using
# the previously saved workspace, but you should be able
# to do this using the getGEO function from GEOquery
###############################################################
...
# each probe. Otherwise, outlier probes (with relatively high 
