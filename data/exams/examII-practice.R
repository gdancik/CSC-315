...
#    write a function that randomly draws a 2-card hand from a deck, and 
#    returns TRUE if the hand is a blackjack. Then simulate 5000 blackjack games
...
#     such as p and mu, and definitions for what they mean)
...
#   a group of patients (also see next question). The new drug is compared to an old one.
